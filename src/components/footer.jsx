  ...
  return (
    ...
    />
        ...
        <div className="flex flex-wrap items-start justify-start gap-10 px-4 md:px-10 mt-10 text-sm">
          ...
          {/* Delhi Office */}
          <div className="min-w-[200px]">
            <h3 className="font-semibold mb-2">Delhi</h3>
            <ul className="space-y-1 text-gray-300">
          ...
          {/* Patna Office */}
          <div className="min-w-[200px]">
            <h3 className="font-semibold mb-2">Patna(Regd)</h3>
            <ul className="space-y-1 text-gray-300">
          ...
          <div className="min-w-[220px]">
            ...
            <div className="flex space-x-3 mb-4">
              <a href="https://www.instagram.com/melofilms.co.in?igsh=eXdoOGRzeXFjbjZ0" className="border border-white p-2 rounded-full hover:text-yellow-500"><FaInstagram /></a>
              ...
              <a href="https://share.google/COhDtzpYdFwOAeYhO" className="border border-white p-2 rounded-full hover:text-yellow-500"><FaFacebook /></a>
            </div>
            ...
            <form className="flex flex-col md:flex-row gap-2">
              <input
                ...
                className="bg-gray-900 text-white px-3 py-2 rounded-md w-full md:w-auto"
              />
              <button
                type="submit"
